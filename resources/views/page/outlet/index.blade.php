                                    ...
                                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                        ...
                                        <td class="px-6 py-4">
                                            <button type="button" data-id="{{ $k->id }}" data-nama="{{ $k->nama }}" data-alamat="{{ $k->alamat }}"
                                                data-modal-target="sourceModal" onclick="editSourceModal(this)"
                                                class="bg-amber-500 hover:bg-amber-600 px-3 py-1 rounded-md text-xs text-white">Edit</button>
                                            <button onclick="return outletDelete('{{ $k->id }}', '{{ $k->nama }}')"
                    ...
                    <div class="flex flex-col  p-4 space-y-6">
                        <div class="">
                            ...
                            <input type="text" id="nama" name="nama"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                placeholder="Masukan outlet disini...">
                        </div>
                    </div>
                    <div class="flex flex-col  p-4 space-y-6">
                        <div class="">
...
<script>
    ...
    const url = "{{ route('outlet.update', ':id') }}".replace(':id', id);
    ...
    // Pastikan CSRF token dan method input hanya ditambahkan sekali
    ...
    let confirmDelete = confirm(`Apakah anda yakin untuk menghapus outlet ${nama}?`);
    if (confirmDelete) {
